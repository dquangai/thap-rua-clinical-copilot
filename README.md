...
Mở URL Vite hiển thị trong terminal. Chạy backend ở terminal khác bằng npm run dev:backend; health check tại http://localhost:4000/health. Bản demo frontend hiện tại dùng dữ liệu mock, chưa kết nối dữ liệu bệnh nhân thật.
